...
CUDA_VISIBLE_DEVICES=2 python tracking/test.py mcitrack mcitrack_b224 --dataset lasot --threads 1
python tracking/analysis_results.py # need to modify tracker configs and names
```
- LaSOT_ext
```
python tracking/test.py mcitrack mcitrack_b224 --dataset lasot_extension_subset --threads 4 --num_gpus 2
python tracking/analysis_results.py # need to modify tracker configs and names
```

- GOT10K-test
```
CUDA_VISIBLE_DEVICES=0 python tracking/test.py mcitrack mcitrack_b224_got --dataset got10k_test --threads 1
python lib/test/utils/transform_got10k.py --tracker_name mcitrack --cfg_name mcitrack_b224_got
```
- TrackingNet
```
CUDA_VISIBLE_DEVICES=1 python tracking/test.py mcitrack mcitrack_b224 --dataset trackingnet --threads 1
...
- UAV123
```
CUDA_VISIBLE_DEVICES=1 python tracking/test.py mcitrack mcitrack_b224 --dataset uav --threads 1
python tracking/analysis_results.py # need to modify tracker configs and names
```
- NFS
```
...
```
CUDA_VISIBLE_DEVICES=1 python tracking/profile_model.py --script mcitrack --config mcitrack_b224
```
