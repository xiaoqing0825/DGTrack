...
## Test and Evaluation
CUDA_VISIBLE_DEVICES=2 python tracking/test.py odtrack baseline  --dataset lasot_extension_subset --runid 300 --threads 2 --num_gpus 2
- LaSOT or other off-line evaluated benchmarks (modify `--dataset` correspondingly)
```
CUDA_VISIBLE_DEVICES=2 python tracking/test.py odtrack baseline --dataset lasot --runid 300 --threads 2 --num_gpus 2
python tracking/analysis_results.py # need to modify tracker configs and names
```
- GOT10K-test
```
CUDA_VISIBLE_DEVICES=1 python tracking/test.py odtrack baseline_got --dataset got10k_test  --runid 100 --threads 1 --num_gpus 1
python lib/test/utils/transform_got10k.py --tracker_name odtrack --cfg_name baseline_got_100
```
- TrackingNet
```
CUDA_VISIBLE_DEVICES=0 python tracking/test.py odtrack baseline --dataset trackingnet  --runid 300 --threads 1 --num_gpus 1
python lib/test/utils/transform_trackingnet.py --tracker_name odtrack --cfg_name baseline_300
```
- uav123
CUDA_VISIBLE_DEVICES=2 python tracking/test.py odtrack baseline --dataset uav  --runid 300 --threads 1 --num_gpus 1

- TC128
CUDA_VISIBLE_DEVICES=1 python tracking/test.py odtrack baseline --dataset tc128  --runid 300 --threads 1 --num_gpus 1
- 
- OTB100
CUDA_VISIBLE_DEVICES=2 python tracking/test.py odtrack baseline --dataset otb  --runid 300 --threads 1 --num_gpus 1
- 
- VOT2020
```
...
bash exp.sh
```
Grassmannian/k3/a0.05_rs_rt_5_50_5/otb
